# Math Magicians
A Single Page App (SPA) for mathematicians that allows simple calculations and generate a random math-related quote.
## Built With
- React
- JavaScript
- Webpack
...
- Type 'git clone https://github.com/Draxeytina/math-magicians.git'
...
This project is [MIT](https://github.com/Draxeytina/math-magicians/MIT.md) licensed.
